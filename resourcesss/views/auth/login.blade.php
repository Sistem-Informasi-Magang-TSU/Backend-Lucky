            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-5 w-full max-w-md">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" required
                            placeholder="Masukkan Email WAJIB Berdomain @tsu.ac.id"
                            class="w-full border border-gray-400 px-4 py-3 rounded text-sm focus:outline-none focus:border-tsu-teal focus:ring-1 focus:ring-tsu-teal">
                    </div>
                    ...
                    <button type="submit"
                        class="w-full bg-tsu-teal text-white font-bold py-3 rounded-lg hover:bg-tsu-teal-dark transition shadow-lg mt-4">
                        Masuk
                    </button>
                </form>
