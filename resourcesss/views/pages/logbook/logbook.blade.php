...
@section('content')
    ...
    <script>
        ...
        const emptyStateAdd = document.getElementById('emptyStateAdd'); // ID baru
        ...
        emptyStateAdd.addEventListener('click', toggleModal); // Klik teks langsung buka modal
        ...
        filterBtn.addEventListener('click', function() {
            const filterValue = filterDateInput.value; // Format: YYYY-MM-DD
